...
#define szQUERY_SIZE 5000
		...
		snprintf(szQuery, sizeof(szQuery), "%s",
			"select \
 			 a.dormant_id, a.network_info_id, a.lcd_on_timeout, a.lcd_off_timeout\
 			 from fast_dormancy a, network_info b\
 			 where b.mccmnc= ? and a.network_info_id = b.network_info_id ");
